---
title: "子供が自分でEC2のマイクラサーバーを操作できるように家族用Alexaスキルを作ってみた"
emoji: "🔊"
...
これはエンジニア転職の[LAPRAS](https://lapras.com/)/エンジニア採用の[LAPRAS SCOUT](https://scout.lapras.com/)を提供する[LAPRASのアドベントカレンダー2023](https://qiita.com/advent-calendar/2023/lapras)の15 日目の記事です。
