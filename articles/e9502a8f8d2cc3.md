---
title: "子供だけでEC2のマイクラサーバーを操作できるように - Alexaスキル開発"
emoji: "🔊"
...
※ 仕事場の Echo show で動画撮影していますが、普段はリビングの Echo を使っています。

今はもう子供が自分で自由にマイクラサーバーを起動・停止しています。少しですが父の仕事ぶりを見せられたので、良かったかなと思ってます💪
