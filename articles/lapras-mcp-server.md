...
今のところWAFの発動や、異常なリクエストもなく安定しています。監視体制があることで安心してリリースできているので、初期に整えてよかったなと思います。SREチームの[@なっぱ](https://x.com/b7472)と[@Kumamoto](https://x.com/digitalhimiko)に感謝です。
...
今回提供するツールはユーザーによって確認・修正が可能なものなので、リスクを考えつつもリリースに踏み切りましたが、やり直しの効かない操作（例えば転職サービスなら応募やメッセージの送信など）での利用は、まだ難しいと感じました。
