...
ぎっくり腰（椎間板ヘルニア）で、ほぼ寝たきりになってしまったので、そのような中でも何とかコードを書くための技術をまとめました。
...
これをとりあえず購入すれば、腰を刺激せずベッドの上で仰向けの状態から PC を操作できるようになります。

しかし、見ればわかると思うのですが、手を上げながらのタイピングはかなりきついです。写真の方のようなフォームでタイピングすれば、腰の代わりに首・手首・肘を壊すこと必須でしょう 🥲
