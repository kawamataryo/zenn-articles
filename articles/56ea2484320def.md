...
以前[こちらの記事](https://zenn.dev/ryo_kawamata/articles/291c95b41baeb7)では、GPT3 の Completion API を使って Chat GPT ライクな Slack Bot を作っていましたが 2023/03/02（日本時間）、ついに [Chat Completion API](https://platform.openai.com/docs/guides/chat) が公開されたので、早速そちらを作う形で修正してみました。
